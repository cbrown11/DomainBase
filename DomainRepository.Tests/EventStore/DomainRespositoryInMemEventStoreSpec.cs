...
using DomainRespositoryInMemEventStore.Tests.Domain.TestEntityAggregate;
using Machine.Specifications;
using Moq;
using It = Machine.Specifications.It;

namespace DomainRespositoryInMemEventStore.Tests.EventStore
{

    public abstract class DomainRespositoryInMemEventStoreSpec
    {
    ...
    public class when_saving_a_new_aggregate: DomainRespositoryInMemEventStoreSpec
    {
    ...
    [Subject(typeof(InMemEventStoreDomainRespository))]
    public class WhenSaving10DomainRespositoryInMemEventsToTheAggregate : DomainRespositoryInMemEventStoreSpec
    {
        protected static TestEntityAggregate TestEntityAggregate;
        protected static string Id;
    ...
    [Subject(typeof(InMemEventStoreDomainRespository))]
    public class WhenSavingOver200DomainRespositoryInMemEventsToTheAggregate : DomainRespositoryInMemEventStoreSpec
    {
        protected static TestEntityAggregate TestEntityAggregate;
        protected static string Id;
    ...
    [Subject(typeof(InMemEventStoreDomainRespository))]
    public class WhenHandlingOverDomainRespositoryInMemEventsLimitOfTheAggregate : DomainRespositoryInMemEventStoreSpec
    {
        protected static TestEntityAggregate TestEntityAggregate;
        protected static string Id;
